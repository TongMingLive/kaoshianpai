...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="suoyoujiaoshi_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=suoyoujiaoshi" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="suoyoujiaoshi_list.jsp?page=1">首页</a>　<a href="suoyoujiaoshi_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="suoyoujiaoshi_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="suoyoujiaoshi_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
