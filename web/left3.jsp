  ...
  <tr>
    ...
    <td valign="top" width="180" bgcolor="#ffffff">
      <table cellspacing="0" cellpadding="3" width="165" align="center" border="0">
        ...
        <tr>
          <td class="mainMenu" onClick="MenuDisplay('table_1');"> <span class="span" id="table_1Span">＋</span> 学生资料管理</td>
        </tr>
        <tr>
          <td>
            <table id="table_1" style="DISPLAY: none" cellspacing="0" cellpadding="2"   width="155" align="center" border="0">
              <tbody>
               ...
               <tr>
                <td class="menuSmall"><a class="style2"  href="xueshengxinxi_updt2.jsp"  target="whlmain">－ 资料修改</a></td></tr>
              </tbody>
             </table>
          </td>
        </tr>
        ...
        <tr>
          <td class="mainMenu" onClick="MenuDisplay('table_2');"><span  class="span" id="table_2Span">＋</span> 我的考试信息</td></tr>
        <tr>
          <td>
            <table id="table_2" style="DISPLAY: none" cellspacing="0" cellpadding="2"  width="155" align="center" border="0">
              <tbody>
              <tr>
                <td class="menuSmall"><a class="style2"  href="kaoshixinxi_list2.jsp" target="whlmain">－ 考试信息查看</a></td></tr>
        ...
        <tr>
            <td background="index/YHMenu.files/new_027.jpg" height="1"></td></tr>
        <tr>
            <td class="mainMenu" onClick="MenuDisplay('table_3');"><span  class="span" id="table_3Span">＋</span> 在线考试</td></tr>
        <tr>
            <td>
                <table id="table_3" style="DISPLAY: none" cellspacing="0" cellpadding="2"  width="155" align="center" border="0">
                    <tbody>
                    <tr>
                        <td class="menuSmall"><a class="style2"  href="zaixiankaoshi.jsp" target="whlmain">－ 进入考试答题</a></td></tr>
                    <tr>
                        <td class="menuSmall"><a class="style2"  href="selectkaoshichengji.jsp" target="whlmain">－ 查看考试成绩</a></td></tr>
                    </tbody>
                </table>
            </td>
        </tr>
