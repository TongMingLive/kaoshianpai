...
function check()
{
	...
	if(document.form1.jiaoshixingming.value==""){alert("请输入教师姓名");document.form1.jiaoshixingming.focus();return false;}
	if(document.form1.shenfenzhenghao.value==""){alert("请输入身份证号");document.form1.shenfenzhenghao.focus();return false;}if(document.form1.mima.value==""){alert("请输入密码");document.form1.mima.focus();return false;}
}
</script>
  <body >
  ...
  <br><br>
  <%
  String sql="select * from jiaoshixinxi where jiaoshibianhao='"+request.getSession().getAttribute("username")+"'";
