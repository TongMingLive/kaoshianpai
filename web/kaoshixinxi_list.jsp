...
%>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   &nbsp;&nbsp;姓名：
   <input name="xingming" type="text" id="xingming" style='border:solid 1px #000000; color:#666666' />&nbsp;&nbsp;教室：<input name="jiaoshi" type="text" id="jiaoshi" style='border:solid 1px #000000; color:#666666' /> 
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>教学楼</td>
    <td bgcolor='#CCFFFF'>教室</td>
    <td bgcolor='#CCFFFF'>楼层</td>
    <td bgcolor='#CCFFFF'>科目</td>
    <td width="138" align="center" bgcolor="CCFFFF">考试时间</td>
  ...
  <%
    ...
    int curpage=1;//当前页
				...
				String fysql="select count(id) as ss from kaoshixinxi";
  ...
  zys=zgs/page_record+1;
   ...
   sql="";
  sql="select * from kaoshixinxi where 1=1 ";
...
%>
  <tr>
    ...
    <td width="60" align="center"><a href="del.jsp?id=<%=id %>&tablename=kaoshixinxi" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
