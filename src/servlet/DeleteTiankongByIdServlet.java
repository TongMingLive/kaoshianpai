 ...
 */
@WebServlet(name = "DeleteTiankongByIdServlet",urlPatterns = "/DeleteTiankongByIdServlet")
public class DeleteTiankongByIdServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int r = dao.deleteTiankongById(timuId);
        if (r>0){
